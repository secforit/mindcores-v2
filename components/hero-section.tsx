          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-light text-foreground leading-tight text-balance">
                Your Journey to{" "}
                <span className="text-primary font-medium italic">Mental Wellness</span>{" "}
                Begins Here
              </h1>
            </div>
            
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto lg:mx-0">
              Experience transformative therapy with a compassionate approach. 
              Specialized in EMDR, Mindfulness, NLP, and evidence-based treatments 
